...
MPC rolling RT:
  --multi-scale           use MPC rolling RT with multi-period OPF
  --rt-forecast-mode <m>  perfect | da_as_forecast | noisy_da (default perfect)
  --rt-forecast-noise <p> noise std as % of DA price (default 10)

Example:
  python run.py --scenario high_re --multi-scale --rt-forecast-mode noisy_da --rt-forecast-noise 15
  python run.py --scenario high_re --nash --nash-method fictitious_play --nash-iters 10
"""
import sys, warnings, numpy as np
from models import MarketConfig
from market import clear_market, adaptive_bidding, two_settlement, clear_rt_rolling, clear_rt_rolling_mpc
from nash import NashEquilibriumTester, plot_nash_results
from scenarios import get_scenario
from outputs import save_run_results
...
def main():
    ...
    if run_nash:
        ...
        is_nash, improvements = tester.test_nash_equilibrium(
            da_actions, threshold_abs=30.0, num_variations=20)
